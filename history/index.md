...
| [009](./entries/009-normal-v2-ingestion.md) | 2026-07-13 | Data | 30/60 分钟重采 Normal 数据接入 DVC pipeline | `configs/data/`, `dvc.yaml`, `tests/fixtures/`, `CLAUDE.md` |
...
| `tests/` | 002 (占位), 003 (契约/e2e), 009 (merged_v2_mini fixture) |
| `pyproject.toml` | 002 |
